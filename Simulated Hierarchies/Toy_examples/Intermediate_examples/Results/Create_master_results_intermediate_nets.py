...
lp_main = 'C:/Users/Bruin/Documents/GitHub/HGRN_repo/Simulated Hierarchies/Toy_examples/Intermediate_examples/Results/'
tables = []
...
for idx, case in enumerate(expansion):
    ...
    gam_value = case[-2]
    Aloss_off = case[-1]
    nm = '__gam_'+str(gam_value)+'_delt_'+str(1)+'_reso_'+str(resolu1[i])+'_'+str(resolu2[i])+'_TOAL_'+str(Aloss_off)
...
master_table.to_csv('C:/Users/Bruin/Documents/GitHub/HGRN_repo/Simulated Hierarchies/Toy_examples/Intermediate_examples/Results/MASTER_results.csv')
