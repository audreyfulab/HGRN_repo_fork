...
def run_simulations(save_results = False, which_net = 0, which_ingraph=1, gam = 1, delt = 1, 
    ...
    savepath_main = 'C:/Users/Bruin/Documents/GitHub/HGRN_repo/Simulated Hierarchies/Toy_examples/Intermediate_examples/Results/'
            ...
            for i in range(0, 5):
                ...
                if i == which_ingraph:
                    ...
                    if save_results == True:
                        tables[i].to_csv(savepath_main+'intermediate_sim_results_'+case_nm[i]+'.csv')
