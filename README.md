...
parser2.add_argument('--connect_prob_middle', dest='connect_prob_middle', default=0.1, type=str, help='Sets the probability for edge creation between two nodes in the middle layer of the hierarchy')
parser2.add_argument('--connect_prob_bottom', dest='connect_prob_bottom', default=0.01, type=str, help='Sets the probability for edge creation between two nodes in the bottom layer of the hierarchy')
...
parser2.add_argument('--subgraph_prob', dest='subgraph_prob', default=[0.5, 0.2], type=float, help='Sets the probability of edge creating within small world subgraphs')
parser2.add_argument('--nodes_per_super2', dest='nodes_per_super2', default=(3,3), type=tuple, help='sets the number of offspring for each node in the top layer of the hierarchy')
parser2.add_argument('--nodes_per_super3', dest='nodes_per_super3', default=(20,20), type=tuple, help='Sets the number of offspring for each node in the bottom layer of the hierarchy')
...
parser2.add_argument('--within_edgeweights', dest='within_edgeweights',default = (0.5, 0.8), type=tuple, help='Tuple giving the minimum and maximum weight for an edge between nodes in the same community')
parser2.add_argument('--between_edgeweights', dest='between_edgeweights',default = (0, 0.2), type=tuple, help='Tuple giving the minimum and maximum weight for an edge between nodes in different communities')
