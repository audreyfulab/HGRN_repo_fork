...
if args.use_softKMeans_top:
    mp = '/'.join([mainpath_save, '_'.join(['nobatch', 'Kmeans', args.COMM_operator, '_'.join([str(i) for i in args.community_sizes]), 'opt_clusts', str(args.compute_optimal_clusters)])])
else:
    mp = '/'.join([mainpath_save, '_'.join(['nobatch', args.COMM_operator, '_'.join([str(i) for i in args.community_sizes]), 'opt_clusts', str(args.compute_optimal_clusters)])])
