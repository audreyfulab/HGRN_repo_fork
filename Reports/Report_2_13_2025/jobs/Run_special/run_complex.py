...
mainpath = '/mnt/ceph/jarredk/HGRN_repo/Reports/Report_2_13_2025/Output/Complex_applications'
...
if args.use_softKMeans_top:
    mp = '/'.join([mainpath, '_'.join(['complex', 'Kmeans', args.COMM_operator, '_'.join([str(i) for i in args.community_sizes]), 'opt_clusts', str(args.compute_optimal_clusters)])])
else:
